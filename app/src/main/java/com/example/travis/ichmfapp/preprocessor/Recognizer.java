...
public class Recognizer {
    ...
    /**
     * The trained symbol collection for recognition comparison.
     */
    ...
    private boolean addToList(RecognizedSymbol recognizedChar, List<RecognizedSymbol> candidate, List<RecognizedSymbol> list) throws Exception {
        ...
        while (strokes > 1) {
            ...
            //if previously last recognizd symbol fromt the list is - or dash
    ...
    /**
     * Overloaded version of nternal method to perform symbol Recognition.
